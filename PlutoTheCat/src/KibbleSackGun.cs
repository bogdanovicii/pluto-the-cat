...
namespace PlutoTheCat
{
    ...
    public class KibbleSackGun : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            // Kibble leaves the torn-open zip top of the bag (WeaponLayout, generated from tools/weapon_layout.py). Units: pixels / 16.
            gun.barrelOffset.transform.localPosition = new Vector3(WeaponLayout.KIBBLE_SACK_MUZZLE_X / 16f, WeaponLayout.KIBBLE_SACK_MUZZLE_Y / 16f, 0f);
